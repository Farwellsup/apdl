...
@section('content')
    <div class="listing">
        <div class="listing__nav">
            <div class="container-fluid spacing" ref="form">
                <a17-filter v-on:submit="filterListing" v-bind:closed="hasBulkIds"
                    ...
                    @if($create)
                        <div slot="additional-actions">
                            ...
                            <a href="{{ route('twill.uploadForm') }}" class="button button--small button--validate" style="background: #1d9f3c;color: #fff;">Upload Users</a>
                            <a href="{{ asset('assets/templates/new_users.xlsx')  }}" target="_blank"> New Users Template</a>
                            <a href="{{asset('assets/templates/returning_users.xlsx')}}" target="_blank"> Existing Users Template</a>
