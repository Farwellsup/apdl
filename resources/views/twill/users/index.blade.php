                    ...
                    @if ($create)
                        <div slot="additional-actions">
                            ...
                            <a href="{{ asset('assets/templates/new_users.xlsx') }}" target="_blank"> New Users
                                Template</a>
                            <a href="{{ asset('assets/templates/returning_users.xlsx') }}" target="_blank"> Existing Users
                                Template</a>
    ...
    @if (session()->has('download_url'))
        ...
        <script>
            ...
            async function checkExport() {
                const response = await fetch(`/admin/check-export-status?file=${fileName}`);
                ...
                if (data.ready) {
                    ...
                    // messageEl.innerText = 'Download ready! Starting...';
            ...
            const polling = setInterval(checkExport, 3000);
        </script>
    @endif
@endpush
